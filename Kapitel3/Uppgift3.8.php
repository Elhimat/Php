...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Stickspel 21</title>
	</head>
	<h1>Skriv in namn</h1>
	<form method="POST">
		Namn: <input type="text" name="namn"   required title="Minst 8 tecken" ><br>
...
?>
	...
	if(isset($_POST["gissning"])) {
		...
		$svar="Föregåande tal var...". $_POST["foregaendeTal"];
...
<html>
	...
	<body>
		...
		<form method="POST">
			Jag tor nästa tal blir: <select name="gissning" size="1">
